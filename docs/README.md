...
**Last incremental update:** 2026-08-03  
**SDK versions:** Python v0.120.2, TypeScript v0.115.0  
...
| [sdks.md](./sdks.md) | Python and TypeScript SDK reference, async, pagination | 2026-08-03 |

### Features

| File | Description | Status | Last Updated |
|------|-------------|--------|-------------|
| [tool-use.md](./tool-use.md) | Function calling, agentic loop, tool choice, built-in tools, tool definition properties, mid-conversation tool changes | Stable | 2026-07-27 |
...
| [managed-agents.md](./managed-agents.md) | Persistent agents, sessions, threads, model effort, environments | Beta | 2026-07-27 |
